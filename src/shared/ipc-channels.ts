export const IpcChannels = {
  ...
  projectsGitRemoteUrl: 'projects:gitRemoteUrl',
  projectsGitDefaultBranch: 'projects:gitDefaultBranch',
  projectsCloneStart: 'projects:cloneStart',
  projectsCloneProgress: 'projects:cloneProgress',
  projectsFindClone: 'projects:findClone',
  projectsDefaultCodeRoot: 'projects:defaultCodeRoot',
  projectActivityStart: 'projectActivity:start',
  projectActivityStop: 'projectActivity:stop',
  projectActivityFileDirty: 'projectActivity:fileDirty',
  projectActivityCommit: 'projectActivity:commit',
