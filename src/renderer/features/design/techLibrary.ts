...
export const TECH_LIBRARY: TechEntry[] = [
  ...
  { id: 'nuxt',       label: 'Nuxt',       category: 'frontend', iconSlug: 'nuxtdotjs',  color: '00dc82' },
  ...
  { id: 'lambda',     label: 'AWS Lambda', category: 'service',  iconSlug: 'awslambda',  color: 'ff9900' },
  ...
  { id: 'dynamodb',   label: 'DynamoDB',   category: 'database', iconSlug: 'amazondynamodb', color: '4053d6' },
  ...
  { id: 'sqs',        label: 'AWS SQS',    category: 'queue',    iconSlug: 'amazonsqs',  color: 'ff4f8b' },
  { id: 'pubsub',     label: 'GCP Pub/Sub', category: 'queue',   iconSlug: 'googlecloud', color: '4285f4' },
  { id: 'nats',       label: 'NATS',       category: 'queue',    iconSlug: 'nats',       color: '27aae1' },
  ...
  { id: 'twilio',     label: 'Twilio',     category: 'external', iconSlug: 'twilio',     color: 'f22f46' },
  ...
  { id: 'segment',    label: 'Segment',    category: 'external', iconSlug: 'twilio',     color: '52bd95' },
  ...
  { id: 's3',         label: 'AWS S3',     category: 'external', iconSlug: 'amazons3',   color: '569a31' },
  { id: 'r2',         label: 'CF R2',      category: 'external', iconSlug: 'cloudflare', color: 'f38020' },
  { id: 'openai',     label: 'OpenAI',     category: 'external', iconSlug: 'openai',     color: '412991' },
  { id: 'anthropic',  label: 'Anthropic',  category: 'external', iconSlug: 'anthropic',  color: 'd97757' },
